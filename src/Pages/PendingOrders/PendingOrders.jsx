...
//                         <li key={index} className="bg-white border border-gray-200 rounded-lg shadow-md p-4">
//                             <div className="mb-2">
                ...
                <ul className="space-y-4">
                    {orders.map((order, index) => (
                        <li
                            ...
                            onClick={() => handleOrderClick(order._id)} // Click handler to navigate to the order details
                        >
                            <div className="mb-2">
                                <p className="font-semibold text-lg">Order ID: {order._id}</p>
                                <p className="text-gray-600">Order Date: {new Date(order.orderDate).toLocaleString()}</p>
